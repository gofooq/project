...
//   bool showMonthly = false; // ตัวแปรเพื่อระบุว่าจะแสดงกราฟรายเดือนหรือรายวัน
...
//   List<CarbonData> _filterDataByMonth() {
//     Map<String, double> monthlyData = {};

//     for (var data in chartData) {
//       String monthKey =
//           DateFormat('yyyy').format(data.date); // กำหนดคีย์เป็นเดือนและปี
//       if (monthlyData.containsKey(monthKey)) {
//         monthlyData[monthKey] = monthlyData[monthKey]! + data.totalCarbonAmount;
//       } else {
//         monthlyData[monthKey] = data.totalCarbonAmount;
//       }
//     }
...
//     return showMonthly
//         ? DateFormat('yyyy').format(date) // สำหรับรายเดือน
//         : DateFormat('MM-yyyy').format(date); // สำหรับรายวัน
//   }

//   @override
//   Widget build(BuildContext context) {
//     List<CarbonData> dataToShow =
//         showMonthly ? _filterDataByMonth() : chartData;
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('กราฟแสดงปริมาณคาร์บอนทั้งหมด'),
...
//               ),
//               child: Text(
//                 'ปริมาณคาร์บอนที่ปล่อยทั้งหมด: ${totalCarbonSum.toStringAsFixed(2)} กก. CO2',
//                 style: TextStyle(
//                     fontSize: 18,
...
//             ),
//             SizedBox(height: 16),
//             // ปุ่ม "ถัดไป" เพื่อแสดงกราฟรายเดือน
//             ElevatedButton(
//               onPressed: () {
//                 setState(() {
//                   showMonthly = !showMonthly; // สลับโหมดการแสดงผล
//                 });
//               },
...
//                               (DateTime date) => _formatDate(
//                                   date), // ใช้ฟังก์ชันจัดรูปแบบวันที่
//                             ),
//                           ),
//                           behaviors: [
...
//                                 )),
//                             charts.ChartTitle('ปริมาณคาร์บอนทั้งหมด (กก. CO2)',
...
//   List<CarbonData> chartData = [];
//   List<CarbonData> creditData = []; // List to hold carbon credit data
//   double totalCarbonSum = 0.0;
//   double totalCreditSum = 0.0; // Total carbon credits
//   bool showMonthly = false; // ตัวแปรเพื่อระบุว่าจะแสดงกราฟรายเดือนหรือรายวัน
//   bool showCarbonChart = true; // ตัวแปรเพื่อระบุว่าจะเลือกแสดงกราฟไหน

//   @override
//   void initState() {
//     super.initState();
//     _fetchCarbonData();
//     _fetchCarbonCreditData(); // Fetch the carbon credit data
//   }
...
//     List<CarbonData> creditsToShow = _filterCreditDataByYear(); // Show carbon credit as yearly
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('กราฟแสดงปริมาณคาร์บอน และคาร์บอนเครดิต',style: TextStyle(fontSize: 18), ),
//         backgroundColor: Colors.green[800],
//       ),
//       body: Padding(
//         padding: const EdgeInsets.all(16.0),
...
//           crossAxisAlignment: CrossAxisAlignment.stretch,
//           children: [
//             // ปุ่มเปลี่ยนกราฟระหว่างคาร์บอนและคาร์บอนเครดิต
//             Center(
//               child: ToggleButtons(
//                 children: [
//                   Padding(
...
//             ),
//             SizedBox(height: 16),
//             // แสดงกราฟสำหรับคาร์บอนทั้งหมดหรือคาร์บอนเครดิตตามที่เลือก
//             Expanded(
...
//             ),
//             SizedBox(height: 16),
//             // แสดงข้อความรวมปริมาณคาร์บอนหรือคาร์บอนเครดิต
//             Text(
//               showCarbonChart
