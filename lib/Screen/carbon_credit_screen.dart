...
// import 'package:firebase_auth/firebase_auth.dart';
// import 'package:flutter/material.dart';
// import 'package:flutter/services.dart'; // ต้องเพิ่มเพื่อใช้ InputFormatter
// import 'package:flutter_application_7/page/carbon_page.dart';
...
//                       //   // ตรวจสอบว่าถ้ากรอกเส้นผ่านศูนย์กลางแล้ว ต้องกรอกความสูงด้วย
//                       //   if (_diameters[index] > 0 && _heights[index] == 0) {
//                       //     ScaffoldMessenger.of(context).showSnackBar(
//                       //       SnackBar(content: Text('กรุณากรอกความสูงของต้นไม้ที่ ${index + 1}')),
//                       //     );
//                       //   }
//                       // },
//                     ),
...
//                       //   // ตรวจสอบว่าถ้ากรอกความสูงแล้ว ต้องกรอกเส้นผ่านศูนย์กลางด้วย
//                       //   if (_heights[index] > 0 && _diameters[index] == 0) {
//                       //     ScaffoldMessenger.of(context).showSnackBar(
//                       //       SnackBar(content: Text('กรุณากรอกเส้นผ่านศูนย์กลางของต้นไม้ที่ ${index + 1}')),//กรุณากรอกเส้นผ่านศูนย์กลางของต้นไม้ที่
//                       //     );
//                       //   }
//                       // },
//                     ),
