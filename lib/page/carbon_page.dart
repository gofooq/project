...
//     super.initState();
//     _loadSavedResults();
//     _saveResults(); // บันทึกผลลัพธ์ที่ส่งมาจากหน้าคำนวณ
//   }
...
//     // โหลดรายการที่มีอยู่ก่อนหน้า
//     // final existingResults = prefs.getStringList('savedResults') ?? [];
    
//     // แปลงผลลัพธ์ใหม่ให้เป็น String เพื่อเก็บใน SharedPreferences
//     final newResults = widget.results.entries.map((entry) {
//       return '${entry.key}|${entry.value}';
//     }).toList();
    
//     // รวมรายการเก่ากับรายการใหม่
//     // final resultsToSave = existingResults + newResults;
    
//     // await prefs.setStringList('savedResults', resultsToSave);
//     _loadSavedResults(); // โหลดข้อมูลใหม่เพื่อแสดงใน ListView
//   }
...
//               ),
//             ),
//             // ปุ่มเสร็จสิ้นที่อยู่ตรงกลางด้านล่าง
//             Align(
//               alignment: Alignment.bottomCenter,
//               child: ElevatedButton(
//                 onPressed: () {
